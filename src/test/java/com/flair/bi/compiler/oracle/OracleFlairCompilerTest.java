...
public class OracleFlairCompilerTest extends AbstractSqlCompilerUnitTest<OracleFlairCompiler> {
	...
	public void parseFlairIntervalAndCastOperation() throws CompilationException {
		stmtTest(
				...
				"SELECT updated_on as updated_on, COUNT(transaction_quantity) as transaction_quantity FROM shipment3 WHERE updated_on BETWEEN sysdate AND (to_timestamp('2019-11-03 22:00:00.000','YYYY-MM-DD HH24:MI:SS.FF3') - interval '4' hour(1)) GROUP BY updated_on ORDER BY transaction_quantity DESC,updated_on DESC OFFSET 0 ROWS FETCH NEXT 20 ROWS ONLY");
	}
